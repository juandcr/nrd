...
@Component({
  selector: 'app-toggle-survey',
  templateUrl: './toggle-survey.component.html',
  styleUrls: ['./toggle-survey.component.css']
})
export class ToggleSurveyComponent implements OnInit {
